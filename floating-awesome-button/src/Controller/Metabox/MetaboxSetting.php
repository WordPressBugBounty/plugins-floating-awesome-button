...
class MetaboxSetting extends Base implements Model_Interface {
    ...
    public function metabox_settings() {
        add_meta_box(
            ...
            __( 'Setting', 'floating-awesome-button' ),
            array( $this, 'metabox_settings_callback' ),
            'fab',
            'normal',
            'default',
    ...
    private function enqueue_setting_script( $fab ) {
        ...
        $this->WP->wp_localize_script(
            ...
            'FAB_METABOX_SETTING',
            apply_filters(
                'fab_backend_enequeue_metabox_setting_localize',
                array(
                    ...
                    array(
                        'setting' =>
                            array(
                                ...
                                'metabox'     => array(
                                    'preview' => __( 'Preview', 'floating-awesome-button' ),
                                ),
                            ),
                    ),
                )
                        ...
                        'button' =>
                            array(
                                ...
                                'shape'      => array(
                                    ...
                                    'info'    => sprintf(
                                        __( 'Please refer to %s to see the shape', 'floating-awesome-button' ),
                                ...
                                'hotkey'     => array(
                                    ...
                                    'info'    => sprintf(
                                        __( 'Please refer to %s to see supported hotkey', 'floating-awesome-button' ),
