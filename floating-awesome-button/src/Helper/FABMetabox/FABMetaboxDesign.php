...
class FABMetaboxDesign extends Metabox {
    ...
    public function setDefaultInput() {
        ...
        /** Transform Data */
        $this->params['fab_modal_navigation'] = Helper::getInstance()->transformBooleanValue( $this->params['fab_modal_navigation'] );
        $this->params['fab_design_responsive'] = Helper::getInstance()->transformBooleanValue( $this->params['fab_design_responsive'] );
        $this->params['fab_design_tooltip']['alwaysdisplay'] = Helper::getInstance()->transformBooleanValue( $this->params['fab_design_tooltip']['alwaysdisplay'] );
    }
